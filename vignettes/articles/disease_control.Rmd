...
```
![Distribution of differential association p-values](./vignettes/figures/dc_pval.png){width=360 height=360}
...
![Heatmap of differential peak-gene associations](./vignettes/figures/dc_heatmap.png){width=65%}
